return {
    -- Base configuration taken from kickstart.nvim and changed where needed. (Reference: https://github.com/nvim-lua/kickstart.nvim/blob/master/init.lua#L466)
    ...
    config = function()
        ...
        vim.list_extend(ensure_installed, {
            -- Here we put any Mason package that we want installed on the system but it's NOT an LSP
